...
* **Automatisierte Tests:** Test-Infrastruktur auf Basis des nativen Node.js Test-Runners mit 135 Tests.
...
2.  **Datei erstellen:**
    ...
    services:
      loxhuebridge:
        ...
        volumes:
          - ./data:/app/data
        # Begrenzt die Docker-Logdatei, sonst wächst sie im Dauerbetrieb unbegrenzt
        logging:
          driver: "json-file"
          options:
            max-size: "10m"
